...
// WiFi
const char *ssid = "MANG DAY KTX H2-1107"; // Enter your WiFi name
const char *password = "h211072022";  // Enter WiFi password

// MQTT Broker
const char *mqtt_broker = "h30bb6dd.ala.us-east-1.emqxsl.com";// broker address
const char *topic = "esp32/test"; // define topic 
const char *mqtt_username = "esp32"; // username for authentication
const char *mqtt_password = "admin";// password for authentication
